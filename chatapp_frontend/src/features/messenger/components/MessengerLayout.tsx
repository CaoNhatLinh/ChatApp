...
import { useMessenger, useMessengerSetup } from '@/features/messenger/hooks/useMessenger';
import { ChatSidebar } from '@/features/messenger/components/ChatSidebar/ChatSidebar';
import { ChatWindow } from '@/features/messenger/components/ChatWindow/ChatWindow';
import { ContactListView } from '@/features/messenger/components/Contacts/ContactListView';
    ...
    if (loading && !error) {
        return (
            <div className="h-screen w-full flex items-center justify-center bg-background relative overflow-hidden">
                {/* Background blobs for loading screen */}
    ...
    if (error) {
        return (
            <div className="h-screen w-full flex items-center justify-center bg-background p-6 relative overflow-hidden">
                {/* Background blobs for error screen */}
                <div className="absolute inset-0 pointer-events-none opacity-20">
