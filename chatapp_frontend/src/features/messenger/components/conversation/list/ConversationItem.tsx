...
import { conversationErrors, showSuccessToast } from "@/shared/lib/errorHandler";
...
export const ConversationItem = ({ conversation, onConversationSelect }: Props) => {
  ...
  const setActiveConversation = useMessengerStore(state => state.setActiveConversation);
