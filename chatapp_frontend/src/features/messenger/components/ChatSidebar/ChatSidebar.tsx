...
export const ChatSidebar: React.FC = () => {
    ...
    // Determine if we should show the green dot based on myStatus directly for immediate feedback
    ...
    // Track presence for DM participants currently visible
    ...
    return (
        <div className="w-[350px] h-full glass border-r border-border/50 flex flex-col z-20 relative">
            ...
            <div className="p-4 border-t border-border/50 relative">
                <StatusSelector>
                    <div
                        className="relative flex items-center gap-3 p-2 rounded-2xl transition-colors group cursor-pointer hover:bg-muted/50"
                    >
