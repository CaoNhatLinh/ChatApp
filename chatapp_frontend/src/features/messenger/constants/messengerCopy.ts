...
const rawMessengerCopy = {
  ...
  createRoomModal: {
    ...
    roomTypeChannelHint: "Không gian theo chủ đề",
    channelScopeLabel: "Phạm vi kênh",
    privateChannel: "Kênh riêng tư",
    privateChannelHint: "Chỉ tham gia qua lời mời",
    communityChannel: "Cộng đồng",
    communityChannelHint: "Không gian mở cho nhiều người",
    joinPolicyLabel: "Cách tham gia",
    directJoin: "Tham gia ngay",
    directJoinHint: "Không cần quản trị viên duyệt",
    approvalRequired: "Cần phê duyệt",
    approvalRequiredHint: "Quản trị viên duyệt từng yêu cầu",
