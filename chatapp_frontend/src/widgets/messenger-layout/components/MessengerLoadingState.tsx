  ...
  return (
    <div className="relative flex h-full min-h-[520px] w-full items-center justify-center overflow-hidden bg-background p-6">
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 text-center">
        <motion.div className="brand-mark h-12 w-12 rounded-[0.8rem]" initial={UI_MOTION_CONFIG.initialState} animate={UI_MOTION_CONFIG.animateState} variants={UI_MOTION_VARIANTS.loadingSpin} aria-hidden="true"><img src="/noi-mark.svg" alt="" className="h-full w-full object-contain" /></motion.div>
