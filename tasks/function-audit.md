...
| Personal appearance | Global/per-room theme, private background/bubbles, safe asset references | Partial | Frontend theme/settings UI exists and browser storage is namespaced by authenticated user; backend preference sync, source-controlled preference registry and cross-account live proof remain. |
