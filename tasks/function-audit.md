...
| Browser E2E | Partial | `scripts/browser-smoke.mjs`, `locale-smoke.mjs`, `admin-route-smoke.mjs`, `notification-settings-smoke.mjs`, `contacts-locale-smoke.mjs`, `profile-locale-smoke.mjs`, and `search-filter-smoke.mjs` pass their bounded journeys; authenticated multi-account E2E is still pending. |
...
721 static Vietnamese copy keys are checked and currently have no missing
