...
- Frontend `npm run validate`, Next production build và public/deep-link Playwright smoke đều pass với lint zero warning. Build vẫn có hai chunk vượt 500 kB.
