...
- Backend canonical hiện có 96 production source và 73 test cases pass; clean-stack integration vẫn chưa có.
- Frontend `npm run validate`, Next production build và public/deep-link Playwright smoke đều pass. Lint không có lỗi nhưng hiện còn 6 cảnh báo `react-refresh/only-export-components` trong module i18n; build vẫn có hai chunk vượt 500 kB.
