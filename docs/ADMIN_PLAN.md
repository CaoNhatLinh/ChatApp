...
| Messages & audit | authorized message lookup, deletion/tombstone review, immutable audit timeline, bounded export | Monthly audit timeline implemented; message investigation and export pending |
