...
Current evidence (2026-08-29): backend Java 20 `./mvnw test` = 96 tests, 0 failures, 0 errors
...
mock-authenticated `npm run test:e2e:admin`, `npm run test:e2e:contacts`, `npm run test:e2e:profile`, and `npm run test:e2e:search` pass. The locale smoke also passes
