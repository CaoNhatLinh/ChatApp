...
| ID-ADMIN-002 | Admin moderation/analytics/investigation | Partially implemented | report queue/resolution, APP/CONVERSATION sanctions and bounded daily analytics panel are implemented; language moderation, appeals, metric dashboards, message investigation and bounded export remain planned |
